<?php
require 'header.php';
require 'paginationsitonijaapartmani.php';?>
                ...
                <div class="slider-banner-container">
                    <div class="slider-banner-boxedwidth">
                        <ul class="slides">
                            ...
                            <!-- ================ -->
                            <?php
                            $results1 = mysqli_query($con, "SELECT * FROM tekst WHERE kapaciteti='Ситонија/Апартмани' ORDER BY id DESC LIMIT 5");
                            ...
                            data-saveperformance="on" data-title="'.$popust1.'">
                            <!-- main image -->
