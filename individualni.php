<?php
require 'header.php';
require 'paginationindividualni.php';?>
<!-- banner start -->
<!-- ================ -->
<!-- breadcrumb start -->
<!-- ================ -->
<div class="breadcrumb-container">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active">Индивидуални патувања</li>
        </ol>
    </div>
</div>
<!-- breadcrumb end -->
            ...
            <div class="slider-banner-container">
                <div class="slider-banner-boxedwidth">
                    <ul class="slides">
                        ...
                        <!-- ================ -->
                        <?php
                        $results1 = mysqli_query($con, "SELECT * FROM tekst WHERE type ='Индивидуални патувања' ORDER BY id DESC LIMIT 5");
