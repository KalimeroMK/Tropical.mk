<?php
require 'header.php';
require 'paginationzlatibor.php';?>
                ...
                <div class="slider-banner-container">
                    <div class="slider-banner-boxedwidth">
                        <ul class="slides">
                            ...
                            <!-- ================ -->
                            <?php
                            $results1 = mysqli_query($con, "SELECT * FROM tekst WHERE grad='Златибор' ORDER BY id DESC LIMIT 5");
                        ...
                        data-speed="500"
                        data-start="1000"
                        data-easing="easeOutQuad"><span class="text-default">50% </span>' . $title1 . '
                    </div>
                    <!-- LAYER NR. 2 -->
