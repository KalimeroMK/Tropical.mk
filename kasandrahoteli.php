<?php
require 'header.php';
require 'paginationkasandrahoteli.php';?>
                ...
                <div class="slider-banner-container">
                    <div class="slider-banner-boxedwidth">
                        <ul class="slides">
                            ...
                            <!-- ================ -->
                            <?php
                            $results1 = mysqli_query($con, "SELECT * FROM tekst WHERE kapaciteti='Касандра/Хотели' and approved ='1' ORDER BY id DESC LIMIT 5");
