<?php
require 'header.php';
require 'paginationkopaonik.php';?>
                ...
                <div class="slider-banner-container">
                    <div class="slider-banner-boxedwidth">
                        <ul class="slides">
                            ...
                            <!-- ================ -->
                            <?php
                            $results1 = mysqli_query($con, "SELECT * FROM tekst WHERE grad ='Копаоник' and approved ='1' ORDER BY id DESC LIMIT 5");
                        ...
                        <li data-transition="random" data-slotamount="7" data-masterspeed="500"
                            data-saveperformance="on" data-title="Носталгија Травел">
                            <!-- main image -->
                            <img src="http://dev.nostalgijatravel.mk/' . $image1 . '" alt="' . $title1 . '" data-bgposition="center top"
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        ...
                        if (!($image = $row['slika'])) {
                            ...
                            echo ' <img src="http://dev.nostalgijatravel.mk/' . $image . '"  alt="' . $title . '" class="img-responsive img-rounded">';
                        }
                        $kopche = '... ';
