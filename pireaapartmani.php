<?php
require 'header.php';
require 'paginationpireaapartmani.php';?>
<!-- banner start -->
<!-- ================ -->
            ...
            <div class="slider-banner-container">
                <div class="slider-banner-boxedwidth">
                    <ul class="slides">
                        ...
                        <!-- ================ -->
                        <?php
                        $results1 = mysqli_query($con, "SELECT * FROM tekst WHERE kapaciteti='Пиреа/Апартмани' and approved ='1' ORDER BY id DESC LIMIT 5");
