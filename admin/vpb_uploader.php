...
if (isset($_POST) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $vpb_with_of_first_image_file = 600;      // You may adjust the width here as you wish
    $vpb_with_of_second_image_file = 1140;     // You may adjust the height here as you wish
        ...
        if ($vpb_file_extensions != "gif" && $vpb_file_extensions != "jpg" && $vpb_file_extensions != "jpeg" && $vpb_file_extensions != "png" && $vpb_file_extensions != "GIF" && $vpb_file_extensions != "JPG" && $vpb_file_extensions != "JPEG" && $vpb_file_extensions != "PNG") {
            ...
            if ($vpb_image_src == "invalid_file_type_realized") {
                ...
                if ($pos === false) {
                    ...
                    $vpb_uploaded_file_movement_two = $vpb_upload_image_directory . "image_large_". rand() . ".jpg";
                }
                ...
                if ($pos === false) {
                    ...
                    $vpb_uploaded_file_movement_two = $vpb_upload_image_directory . "image_large_". rand() . ".gif";
                }
                ...
                if ($pos === false) {
                    ...
                    $vpb_uploaded_file_movement_two = $vpb_upload_image_directory . "image_large_". rand() . ".jpeg";
                }
                ...
                if ($pos === false) {
                    ...
                    $vpb_uploaded_file_movement_two = $vpb_upload_image_directory . "image_large_". rand() . ".png";
                }
