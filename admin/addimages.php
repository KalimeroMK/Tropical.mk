<? require_once 'header.php'; 
  session_start();
    ...
    <p class="breadcrumb" style="text-align: center;">Резолуцијата треба да биде: width: 1550px; height: 450px;</p>
    ...
    <form action="process/processsliderimage.php" method="post" >
        ...
        <div class="form-group">
            <label for="inputName"><?php echo ENTER_LINK_PATH; ?> </label>
            <input type="text" class="form-control" id="inputName" placeholder="<?php echo ENTER_LINK; ?>" name="link">
        </div>
    ...
    <table class="table">
        ...
        <?php echo '<th>' . IMG_TITLE . '</th><th>' . IMAGE . '</th><th>' . IMG_TEXT . '</th><th>' . LINK . '</th><th>' . DELETE . '</th>'; ?>
        <?php
